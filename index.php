            ...
            <div class="col-md-9">
              <div class="container">
                <div class="row justify-content-center">
                  <h2>WELCOME TO BAU HOTEL</h2>
                </div>
                <hr class="bg-danger">
              </div>
              <p class="mt-4">BAU Hotel Antalya brings modern style together with flawless service.</p>
              ...
              <p class="mt-4">Located at the heart of Antalya’s most modern business and shopping region of Antalya and at a short distance to Akdeniz Square, BAU Hotel is located at walking distance to shopping centers of the city.</p>
              <div class="row justify-content-center">
                <h1 class="mt-5">YOUR NEW POINT IN ANTALYA</h1>
              </div>
              <img class="mt-5 responsive" src="images/image.jpg" alt="hotel image">
